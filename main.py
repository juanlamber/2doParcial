...
##MENU
''''IMPORTANTE! YA CREAMOS DISTINTOS USUARIOS PARA FACILITARLES INGRESAR AL PROGRAMA!!!
'''
try:
    ...
    hotelPOO.dict_habitacion= {'100':Habitacion(100,'SIMPLE',2,'CON BAÑO','CON BALCON',100),
                               '101':Habitacion(101,'SIMPLE',2,'CON BAÑO','CON BALCON',100), 
                            '102':Habitacion(102,'SIMPLE',2, 'SIN BAÑO', 'SIN BALCON', 50),
                            '103':Habitacion(103,'SIMPLE',2, 'SIN BAÑO', 'SIN BALCON', 50),
                           '200':Habitacion(200,'DOBLE',4,'CON BAÑO','CON BALCON',200),
                           '201':Habitacion(201,'DOBLE',4,'CON BAÑO','CON BALCON',200),
                           '202':Habitacion(202,'DOBLE',4,'SIN BAÑO','SIN BALCON',150),
                           '203':Habitacion(203,'DOBLE',4,'SIN BAÑO','SIN BALCON',150),
                           '300':Habitacion(300,'FAMILIAR',5,'SIN BAÑO','CON BALCON',150),
                           '301':Habitacion(301,'FAMILIAR',5,'SIN BAÑO','CON BALCON',150),
                           '302':Habitacion(302,'FAMILIAR',5,'CON BAÑO', 'SIN BALCON',200),
                           '303':Habitacion(303,'FAMILIAR',5,'CON BAÑO', 'SIN BALCON',200),
                           '400':Habitacion(400, 'SUITE', 2, 'CON BAÑO', 'CON BALCON', 500),
                           '401':Habitacion(401, 'SUITE', 2, 'CON BAÑO', 'CON BALCON', 500),
                           '402':Habitacion(402, 'SUITE', 2, 'CON BAÑO', 'SIN BALCON', 400)}
    ...
    usuario5=Personal_Administrativo('ninfa','delgado','83838383','11111111111','ninfa@gmail.com','caseros 1032','ninfa','NINFA12345')  #USUARIO DE NINFA
    ...
    hotelPOO.agregar_usuario(usuario5)
    hotelPOO.lista_personal.add_to_end(usuario5)
                ...
                if hotelPOO.dict_usu[nombre_usu].contrasenna == contrasenna and hotelPOO.dict_usu[nombre_usu].fecha_baja==None:    #VERICAMOS QUE EL USUARIO Y CONTRASEÑA COINCIDAN
                    ...
                    if nombre_usu==hotelPOO.admin:                          #MENU DEL ADMINISTRADOR
                        ...
                        while inicio_sub != 'SALIR':
                            continuar=input('Ingrese enter para continuar: ')       #visualizar los resultados mas amigablemente
